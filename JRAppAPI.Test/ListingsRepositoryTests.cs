            ...
            namespace JRAppAPI.Tests
            {
                ...
                },
                {
                    ...
                    ""maxPassengers"": 2
                        ...
                        // Mock the ILogger<ListingsRepository> using Moq
                        var mockLogger = new Mock<ILogger<ListingsRepository>>();

                        // Create an instance of ListingsRepository with the mocked dependencies
                        var listingsRepository = new ListingsRepository(mockAppSettings.Object, mockHttpClientWrapper.Object, mockLogger.Object);
